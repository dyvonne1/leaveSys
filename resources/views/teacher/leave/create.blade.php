<x-layout title="New Leave Request">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('teacher.leave.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="reason" rows="4"
                              class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('reason') border-red-400 @enderror"
                              placeholder="Ilagay ang dahilan ng iyong leave...">{{ old('reason') }}</textarea>
